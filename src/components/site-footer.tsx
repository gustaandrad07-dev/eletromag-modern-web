      ...
      <div className="container-x grid gap-10 py-16 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
            <li className="flex items-start gap-2"><Phone className="mt-0.5 h-4 w-4 text-brand-red-glow" /> (00) 0000-0000</li>
            <li className="flex items-start gap-2"><Mail className="mt-0.5 h-4 w-4 text-brand-red-glow" /> contato@eletromag.com.br</li>
            <li className="flex items-start gap-2"><MapPin className="mt-0.5 h-4 w-4 text-brand-red-glow" /> Brasil</li>
          </ul>
        </div>
      </div>
